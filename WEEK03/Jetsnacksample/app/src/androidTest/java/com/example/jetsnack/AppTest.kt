...
class AppTest {
    ...
    fun app_launches() {
        ...
        composeTestRule.onNodeWithText("Sedang Trend").assertIsDisplayed()
    }
    ...
    fun app_canNavigateToAllScreens() {
        ...
        composeTestRule.onNodeWithText("HOME").assertIsDisplayed()
        composeTestRule.onNodeWithText("Makanan Favorit").assertIsDisplayed()

        // Navigate to Search
        composeTestRule.onNodeWithText("CARI").performClick().assertIsDisplayed()
        composeTestRule.onNodeWithText("Kategori").assertIsDisplayed()

        // Navigate to Cart
        composeTestRule.onNodeWithText("KERANJANG").performClick().assertIsDisplayed()
